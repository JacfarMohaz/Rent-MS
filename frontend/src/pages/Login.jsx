...
function LogIn() {
    ...
    return <div className="bg-gray-500 w-full h-screen">
        <div className="flex justify-center">
            <form className="w-[400px] h-[300px] mt-20 p-5 rounded-lg bg-blue-400 shadow-lg">
                <input value={username} onChange={(e) => setUsername(e.target.value)} className="mb-5 w-[20em] h-[2em] mt-10 outline-none bg-gray-300" type="text" placeholder="Enter Your Email" />
